...
![]({{ '/assets/gifs/markup/marqueehighlight.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/markup/marqueedragannotation.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/markup/marqueesearchlink.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/markup/embed.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/markup/intexthighlight.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/markup/inkembed.gif' | relative_url }}){:.img}