...
![]({{ '/assets/gifs/environment/create_map.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/environment/map_search.gif' | relative_url }}){:.img}

## Pushpins

- Drag and drop pushpin icon onto map to place pushpin
- Click pushpin icon to place icon on center of map
  ![]({{ '/assets/gifs/environment/map_placepin.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/environment/map_select.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/environment/map_createnote.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/environment/map_filter.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/environment/map_link.gif' | relative_url }}){:.img}

With this functionality, we can create some pretty cool results:
![]({{ '/assets/gifs/environment/map_story.gif' | relative_url }}){:.img}
