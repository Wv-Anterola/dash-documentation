    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { slug: 'capabilities' },
            { slug: 'capabilities/documents' },
            { slug: 'capabilities/organization' },
            { slug: 'capabilities/connections-and-trails' },
            { slug: 'capabilities/ai-automation' },
            { slug: 'capabilities/search-import' },
            { slug: 'capabilities/platform' },
          ],
        },
        {
          label: 'Workflows',
        ...
        },
        {
          ...
          items: [
            { slug: 'development' },
            { slug: 'development/extension-points' },
