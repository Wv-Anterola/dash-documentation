...
export default defineConfig({
  ...
  redirects: {
    ...
    '/documents/tempMedia/': '/guides/documents/tempmedia/temporal-media/',
    '/documents/tempMedia/audio/': '/guides/documents/tempmedia/audio/',
    '/documents/tempMedia/video/': '/guides/documents/tempmedia/video/',
