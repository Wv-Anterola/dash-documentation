...
For an overview of the Dash interface, check out the **[Overall Environment page]({{ '/environment/' | relative_url }})**, which will introduce you to how to navigate and organize your Dashboards.
...
- **Begin Typing** to create a text document, simply click anywhere on the freeform and begin typing!
  ![]({{ '/assets/gifs/gettingstarted/dash-create-text.gif' | relative_url }}){:.img}
- **Drag and drop**: drag any of the accepted file types from your computer or a webpage and drop it into your dashboard. This includes images, videos, audio, pdfs, and more!
  ![]({{ '/assets/gifs/gettingstarted/dash-drag-drop.gif' | relative_url }}){:.img}
- **Import**: import using the import menu on the left hand side
  ![]({{ '/assets/gifs/gettingstarted/dash-import.gif' | relative_url }}){:.img}
- **Type `:`** to bring up the document menu, from which you can choose a document to create. You can search for a specific document as well. If you are in Stacking or Schema view, you can click on `+ New`, and type a colon to open the colon menu.
  ![]({{ '/assets/gifs/gettingstarted/dash-colon-menu.gif' | relative_url }}){:.img}

<!-- <div class="img-container">
  <img src="{{ '/assets/gifs/environment/colon-menu.gif' | relative_url }}" alt="colon menu" style="height:300px;"/>
  <img src="{{ '/assets/gifs/environment/colon-stack.gif' | relative_url }}" alt="colon menu" style="height:300px;"/>
</div> -->
...
- **[Text]({{ '/documents/text/' | relative_url }})**: rich (RTF) text documents that support various text and hypertext features
- **[Webpages]({{ '/documents/webpage/' | relative_url }})**: HTML webpages from external sites
- **[PDFs]({{ '/documents/pdf/' | relative_url }})**: PDF files created outside of Dash
- **[Temporal Media]({{ '/documents/tempMedia/' | relative_url }})**: audio and video files
- **[Ink]({{ '/features/ink/' | relative_url }})**: ink strokes drawn with the pen or polygon tool
- **[Images]({{ '/documents/images/' | relative_url }})**: digital images from external sources
...
![]({{ '/assets/gifs/gettingstarted/dash-nested-collection.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-create-collection-marquee.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-marquee.gif' | relative_url }}){:.img}

To use shift-click, hold down the shift key while left-clicking on multiple documents.

![]({{ '/assets/gifs/gettingstarted/dash-shift-click.gif' | relative_url }}){:.img}

To select text in PDFs and webpages (not text documents), click and drag to highlight the desired text.

![]({{ '/assets/gifs/gettingstarted/dash-highlight-select.gif' | relative_url }}){:.img}
...
- **Document chrome**: floating set of tools to change document properties
  ...
  - Accessed via single selection (left or right click)
    ![]({{ '/assets/images/getting-started/document-chrome.png' | relative_url }})
...
- **Properties panel**: panel displaying document type-specific actions
  - Accessed via (A) the double arrows in the top right or (B) the single arrow on the right edge of the screen
    ![]({{ '/assets/gifs/gettingstarted/dash-properties-pane.gif' | relative_url }}){:.img}
- **Right-click/Context menu**: menu displaying actions on documents
  - Accessed by right-clicking anywhere on the target document or selecting the three bars menu at the bottom of the document chrome
    ![]({{ '/assets/gifs/gettingstarted/dash-context-menu.gif' | relative_url }}){:.img}

All documents also have a context-sensitive toolbar. The toolbar contents vary depending on the document type.

![]({{ '/assets/images/getting-started/context-toolbar.png' | relative_url }})
...
- **Close**
  ...
  - All recently closed documents can be accessed through the "My Recently Closed" section in the files portion of the left side-bar. From here, closed documents can be viewed or dragged back onto the canvas.
    ...
    ![]({{ '/assets/gifs/gettingstarted/recently-closed.gif' | relative_url }}){:.img}
...
### **[Freeform]({{ '/views/freeform/' | relative_url }})**
...
### **[Schema]({{ '/views/schema/' | relative_url }})**
...
### **[Stacking]({{ '/views/stacking/' | relative_url }})**
...
### **[Notetaking]({{ '/views/notetaking/' | relative_url }})**
...
## **[Links and Anchors]({{ '/features/linking/' | relative_url }})**
...
For examples on linking between **parts** of documents, check out the [Annotation and Markup]({{ '/getting-started/#annotation-and-markup' | relative_url }}) section below.
...
![]({{ '/assets/gifs/gettingstarted/dash-creating-link.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-create-link-board.gif' | relative_url }}){:.img}
...
The default following behavior is to pan the freeform so that the destination document is in view (if it isn't already) and highlight it in orange. You can customize the link following behavior and more in the [link editing]({{ '/getting-started/#editing-links' | relative_url }}) section of the properties menu.

![]({{ '/assets/gifs/gettingstarted/dash-following-link.gif' | relative_url }}){:.img}

If you toggle the hand pointing right icon on, clicking on the document will now follow the first linked document.

![]({{ '/assets/gifs/gettingstarted/dash-follow-link-onclick.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-edit-link.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-editing-link.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-link-center-zoom.gif' | relative_url }}){:.img}
...
- Show/hide link: toggles the dotted line created by the show/hide anchor tool above.
  ![]({{ '/assets/gifs/gettingstarted/dash-toggle-show-link.gif' | relative_url }}){:.img}
...
In Dash, you can also create links between **parts of documents**. Read the [Annotation and Markup]({{ '/getting-started/#annotation-and-markup' | relative_url }}) section below for examples of how to do this!

## **[Annotation and Markup]({{ '/features/markup/' | relative_url }})**
...
- `Top-right Icon` Click on the annotation icon at the top right of a document to open the annotation sidebar.
  ...
  ![]({{ '/assets/gifs/gettingstarted/dash-annotation-icon.gif' | relative_url }}){:.img}
...
- `Highlight` For text, pdfs, and webpages, you can highlight a piece of text and select the annotation icon that appears. This also creates a `link` between the annotation and selected text. Following the link from annotation to selected text will scroll the selection into view. Clicking on the selected text will follow the link and scroll the annotation into view.
  ...
  ![]({{ '/assets/gifs/gettingstarted/dash-highlight-anno.gif' | relative_url }}){:.img}

- `Search` After highlighting, you can also click the search icon to search for a document to link to.

  ![]({{ '/assets/gifs/gettingstarted/dash-search-anno.gif' | relative_url }}){:.img}
...
- `Marquee` Clicking (left-click) and dragging within an image, webpage, PDF, or video will create a rectangular marquee selection, allowing you to highlight the selected region and create an annotation associated with it. For webpages and pdfs, you can simply click the annotation icon to add an annotation. For other media types, you'll need to drag the annotation icon to another part of the document or freeform to create the annotation. This also creates a `link` between the annotation and marquee selection.
  ...
  ![]({{ '/assets/gifs/gettingstarted/dash-pdf-anno-marquee.gif' | relative_url }}){:.img}

  ![]({{ '/assets/gifs/gettingstarted/dash-image-marquee-anno.gif' | relative_url }}){:.img}
...
- `Selection to Another Document` To create a link from a selection on a document to another document, first perform the selection (usually left-click and dragging). Then, navigate to the bottom toolbar of the overall document, and drag the link icon to the document you want to link to (create a normal link). Because the selection persists on the source document, the **selection** will be linked rather than the whole document.
  ...
  ![]({{ '/assets/gifs/gettingstarted/dash-link-annotation-document.gif' | relative_url }}){:.img}
...
- `Temporal media` On audio and video documents, you can drag a section of the timeline to create an annotation on that time range. You can link other documents to the annotation, and following that link will play that region of the audio or video.
  ...
  ![]({{ '/assets/gifs/gettingstarted/dash-audio-anno.gif' | relative_url }}){:.img}

- `Embed` Type directly on a media document (This can be done on images, pdfs, webpages, and videos).

  ![]({{ '/assets/gifs/gettingstarted/dash-image-text-embed.gif' | relative_url }}){:.img}

- `Ink` Draw ink strokes directly on a document.

  ![]({{ '/assets/gifs/gettingstarted/dash-annotation-ink.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/textannos.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/marqueeannos.gif' | relative_url }}){:.img}
...
## **[Presentation Trails]({{ '/features/trails/' | relative_url }})**
...
![]({{ '/assets/gifs/gettingstarted/dash-create-trail-side.gif' | relative_url }}){:.img}

- Pinning a document or a view.

![]({{ '/assets/gifs/gettingstarted/dash-pin-doc.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-trail-transition.gif' | relative_url }}){:.img}
...
- **Top menu bar:** this pins the canvas with the pan and zoom of the tab as you are currently viewing it
  ![]({{ '/assets/gifs/gettingstarted/dash-pin-with-view.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-pres-layout-content-grouping.gif' | relative_url }}){:.img}

Check out the details on how to pin with layout and content [here]({{ '/features/trails/#other-pinning-options' | relative_url }}), and how to group slides [here]({{ '/features/trails/#slides' | relative_url }}).

#### Reorganizing slides

To reorganize the slides in your trail, simply drag and drop the slides to the order you want.

![]({{ '/assets/gifs/gettingstarted/dash-reorganize-slides.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-slide-editing.gif' | relative_url }}){:.img}
...
![]({{ '/assets/gifs/gettingstarted/dash-present-trail.gif' | relative_url }}){:.img}

Alternatively, you can select the mini-player option from the dropdown to present with a mini-player instead.

![]({{ '/assets/gifs/gettingstarted/dash-pres-miniplayer.gif' | relative_url }}){:.img}

<!-- ## **[Collaboration]({{ '/features/collaboration/' | relative_url }})**
...
![]({{ '/assets/gifs/gettingstarted/sharing.gif' | relative_url }}){:.img} -->
...
Unsure of how to navigate the overall Dash interface? Check out the **[Overall Environment page]({{ '/environment/' | relative_url }})**.
