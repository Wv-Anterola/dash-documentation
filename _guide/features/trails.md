...
- <img align="left" src="{{ '/assets/icons/trails-upscaled.png' | relative_url }}" alt="The trails icon: a dotted path with a flag at the end." width="100" height="100"/>
...
- <img align="left" src="{{ '/assets/icons/pin-upscaled.png' | relative_url }}" alt="The pin icon: a map pin used to mark a slide in a trail." width="100" height="100"/>
