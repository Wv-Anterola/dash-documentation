...
<div class="img-container">
  <img src="{{ '/assets/images/environment/dataViz_doc.png' | relative_url }}" alt="overall dataViz" style="height:400px;"/>
</div>
{: .no_toc }
...
- ### **Basic Graphs:** 
  ...
  ![]({{ '/assets/gifs/dataViz/simple_dataViz.gif' | relative_url }}){:.img}
...
- ### **2D Graphs:** 
  ...
  ![]({{ '/assets/gifs/dataViz/2D_graph.gif' | relative_url }}){:.img}
...
- ### **Schema Tables as Data Visualization:** 
  ...
  ![]({{ '/assets/gifs/dataViz/fromSchema_dataViz.gif' | relative_url }}){:.img}
...
- ### **Setting a Title Column:** 
  ...
  ![]({{ '/assets/gifs/dataViz/titleCol.gif' | relative_url }}){:.img}
