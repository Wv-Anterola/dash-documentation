...
An introduction to the overall environment. To find out more about the overall environment you can go [here](/getting-started/environment/).
...
An explenation of dashboards, tiles & tabs and what they mean in dash. There is a more detailed explanation of dashboards in [here](/getting-started/environment/#dashboards-tiles--tabs)
