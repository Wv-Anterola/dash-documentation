...
| View | What it is for |
| :--- | :--- |
| [Freeform](/views/freeform/) | An unbounded 2D canvas. Dash's primary view. |
| [Schema](/views/schema/) | A table of key-value pairs, for structured sorting and editing. |
| [Stacking](/views/stacking/) | Groups documents by a key, keeping a live preview of each. |
| [Notetaking](/views/notetaking/) | Multiple columns, so you can take notes in one while reading in another. |
