---
title: Create and present trails
description: 'Presentation trails: pinning slides, grouping them, customising transitions, and presenting.'
---
...
![The current Dash Trails panel open beside a planning workspace, showing the New trail action and the area where saved trails appear.](/assets/images/current/dash-trails-panel.webp)

## Creating and Accessing Trails

There are two ways to open up the Presentation Trails sidebar:

- <img align="left" src="/assets/icons/trails-upscaled.png" alt="The trails icon: a dotted path with a flag at the end." width="100" height="100"/>
...
- <img align="left" src="/assets/icons/pin-upscaled.png" alt="The pin icon: a map pin used to mark a slide in a trail." width="100" height="100"/>
...
- ![Screenshot: a document pinned to a presentation trail with the standard pin.](/assets/images/trails/regularpin.png)
...
- **Top menu bar:** this pins the canvas with the pan and zoom of the tab as you are currently viewing it
  ![Screen recording: pinning the canvas from the top menu bar, capturing its current pan and zoom.](/assets/gifs/trails/pinmenuview.gif)
- **Marquee menu:** this option appears when you right click and drag on the canvas to create a marquee selection and pins the canvas with the marquee bounds as the viewport
  ![Screen recording: pinning a marquee selection so its bounds become the slide viewport.](/assets/gifs/trails/pinmarqueeview.gif)
...
- **Pin with layout:** this pins the document saving its current layout state: xy position, width, and height
  ![Screen recording: pinning a document with layout, saving its position, width, and height.](/assets/gifs/trails/pinlayout.gif)
- **Pin with content:** this pins the document content saving its content state such as the text of a text document, the pan and zoom of a collection, the scroll position of a PDF, etc.
  ![Screen recording: pinning a document with content, saving its text, scroll position, or pan and zoom.](/assets/gifs/trails/pincontent.gif)
- **Pin with layout and content:** this saves both layout and content
  ![Screen recording: pinning a document with both layout and content saved.](/assets/gifs/trails/pinlayoutcontent.gif)
...
![Screenshot: A single slide in a presentation trail, with its controls.](/assets/images/trails/slide.png)
...
- **Arrow:** groups slide with the one above it. When presenting, both slides will transition in together and run simultaneously. By default they play in parallel, but clicking the blue arrow line when grouped will switch to series and play one after the other (indicated as the black outline around the arrow)
  ...
  ![Screen recording: grouping two slides with the arrow control so they transition in together.](/assets/gifs/trails/arrows-present-together.gif)
...
![Screen recording: opening the Trails panel and selecting a presentation for editing.](/assets/images/trails/dash-open-trails-pane.gif)
...
![Screen recording: A single slide in a presentation trail, with its controls.](/assets/images/trails/dash-slide-customization.gif)
...
![Screen recording: editing the Bézier timing curve that controls motion between two trail steps.](/assets/images/trails/dash-bezier-editor.gif)
...
![Screen recording: choosing transition movement, effect, direction, and timing for a trail step.](/assets/images/trails/dash-transition-customization.gif)
...
![Screen recording: generating presentation animation settings from a natural-language description.](/assets/images/trails/dash-generate-animations.gif)
...
![Screen recording: Playing a trail in the minimised player.](/assets/gifs/trails/miniplayer.gif)
...
![Screenshot: A presentation trail shown as an ordered list of slides.](/assets/images/trails/preslist.png)
...
![Screenshot: A presentation trail shown as a tree, with branches.](/assets/images/trails/prestree.png)
...
<ProjectNote title="Branching presentation trails">
  Made trails non-linear. A trail can fork, and the dropdown navigation between branches comes from this work. Authoring a branch is still closer to editing a structure than to drawing a path.
</ProjectNote>

<ProjectNote title="Animation remodel for presentation trails">
  Replaced mechanical slide changes with spring physics. Stiffness, damping, and mass are the parameters, which is also what lets the AI customisation path map a phrase like 'settle gently' onto numbers.
</ProjectNote>

[Trails as a concept](/concepts/trails/) explains what
