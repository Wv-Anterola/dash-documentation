---
title: Markup
description: 'Annotation and markup: marquee selections, embedding, text highlighting, and ink on any media document.'
---
...
![Screen recording: Highlighting a rectangular region of a document with a marquee selection.](/assets/gifs/markup/marqueehighlight.gif)
...
![Screen recording: Dragging a marquee annotation out of a document to create a linked document.](/assets/gifs/markup/marqueedragannotation.gif)
...
![Screen recording: Creating a link from a marquee selection to a document found by search.](/assets/gifs/markup/marqueesearchlink.gif)
...
![Screen recording: Embedding one document inside another.](/assets/gifs/markup/embed.gif)
...
![Screen recording: Highlighting a phrase inside a text document.](/assets/gifs/markup/intexthighlight.gif)
...
![Screen recording: Embedding an ink drawing inside a text document.](/assets/gifs/markup/inkembed.gif)

## Related

- [Links and anchors](/concepts/links/) for the model that makes a highlight, a
  marquee, or a timestamp a valid link endpoint.
- [The founding linking and annotation work](/research/cohorts/2019-2020/#linking-and-annotation)
  for where the anchor model came from and why it has not needed revision.
- [Ink](/guides/features/ink/) for drawing as a form of markup.
