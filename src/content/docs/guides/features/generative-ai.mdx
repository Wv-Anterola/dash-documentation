...
<ProjectNote title="Agent tool registry and dynamic tool creation">
  The reason there is an agent at all, and the thing to understand before letting it loose on documents you care about: several of its tools write to the workspace rather than answering questions about it.
</ProjectNote>
