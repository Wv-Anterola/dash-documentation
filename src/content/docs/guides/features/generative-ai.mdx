...
Four of them are document-level features. The
[video generator](/research/cohorts/2026/#video-generator) plans a video as a
sequence of scenes drawn from canvas content, and lets you re-prompt a single
scene rather than starting over.
[Policy testimony and checker documents](/research/cohorts/2026/#policy-testimony-and-policy-checker-documents)
analyse a policy against the testimony linked to it and report back with
citations you can filter by source. The
[inline text actions](/research/cohorts/2026/#selection-aware-text-formatting-actions)
reformat a selection in place, sending and returning HTML so styling survives
the round trip. The
[data-visualisation pipeline](/research/cohorts/2026/#data-visualisation-generation-pipeline)
turns a single request into a usable chart.
