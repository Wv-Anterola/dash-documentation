---
title: Linking
description: 'Creating, following, editing, and deleting links, and the anchors a link can start or end at.'
---
...
![Screen recording: dragging from one document's link handle to another document to create a relationship.](/assets/gifs/gettingstarted/dash-creating-link.gif)
...
![Screen recording: opening a linkboard and selecting source and destination documents for a new link.](/assets/gifs/gettingstarted/dash-create-link-board.gif)
...
fundamental revision since. [Links and anchors](/concepts/links/)
