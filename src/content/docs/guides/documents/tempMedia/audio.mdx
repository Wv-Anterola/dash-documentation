---
title: Audio
description: 'Audio documents: recording inside Dash, trimming, dictation, and anchoring a link to a time range.'
---

![Screenshot: audio doc in Dash.](/assets/images/environment/audio_doc.png)
...
![Screen recording: Creating an audio document and starting a recording.](/assets/gifs/audio/audiocreaterecord.gif)
...
![Screen recording: Dictating into a text document and stopping the dictation.](/assets/gifs/audio/dictation.gif)
...
{/* trimming used to not be destructive */}

![Screen recording: Trimming an audio clip by dragging the handles at each end of the timeline.](/assets/gifs/audio/audiotrimming.gif)
...
![Screen recording: Hiding and showing the link anchor markers on an audio timeline.](/assets/gifs/audio/audiohideanchors.gif)
...
![Screen recording: Following a link anchored to a point in an audio recording.](/assets/gifs/audio/audiolinks.gif)

## Related

- [Temporal media](/guides/documents/tempmedia/temporal-media/) for why a time
  range is a link anchor in the same way a text selection is.
- [Links and anchors](/concepts/links/) for the anchor model underneath that.
- [Dictation and its stop control](/research/cohorts/2024/#presentation-transitions-and-dictation)
  for the project that added speech-to-text on audio documents.
