---
title: Documents
description: 'Creating, selecting, editing, and transforming documents, and the routes that work for every document type.'
---
...
### Import through the flyout panel
...
* A floating toolbar to where users can perform actions on the selected documents including create a collection, summarize, delete, change to text, and pin the selected region to a **[presentation trail](/guides/features/trails/)**
...
[Documents and fields](/concepts/documents/) explains the
