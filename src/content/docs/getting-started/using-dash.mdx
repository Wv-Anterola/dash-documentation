...
For an overview of the Dash interface, check out the **[Overall Environment page](/getting-started/environment/)**, which will introduce you to how to navigate and organize your Dashboards.
...
- **Begin Typing** to create a text document, simply click anywhere on the freeform and begin typing!
  ![](/assets/gifs/gettingstarted/dash-create-text.gif)
- **Drag and drop**: drag any of the accepted file types from your computer or a webpage and drop it into your dashboard. This includes images, videos, audio, pdfs, and more!
  ![](/assets/gifs/gettingstarted/dash-drag-drop.gif)
- **Import**: import using the import menu on the left hand side
  ![](/assets/gifs/gettingstarted/dash-import.gif)
- **Type `:`** to bring up the document menu, from which you can choose a document to create. You can search for a specific document as well. If you are in Stacking or Schema view, you can click on `+ New`, and type a colon to open the colon menu.
  ![](/assets/gifs/gettingstarted/dash-colon-menu.gif)

{/* <div class="img-container">
  ![colon menu](/assets/gifs/environment/colon-menu.gif)
  ![colon menu](/assets/gifs/environment/colon-stack.gif)
</div> */}
...
- **[Text](/guides/documents/text/)**: rich (RTF) text documents that support various text and hypertext features
- **[Webpages](/guides/documents/webpage/)**: HTML webpages from external sites
- **[PDFs](/guides/documents/pdf/)**: PDF files created outside of Dash
- **[Temporal Media](/guides/documents/tempmedia/temporal-media/)**: audio and video files
- **[Ink](/guides/features/ink/)**: ink strokes drawn with the pen or polygon tool
- **[Images](/guides/documents/images/)**: digital images from external sources
...
![Screen recording: nested collection in Dash.](/assets/gifs/gettingstarted/dash-nested-collection.gif)
...
![Screen recording: create collection marquee selection in Dash.](/assets/gifs/gettingstarted/dash-create-collection-marquee.gif)
...
![Screen recording: marquee selection in Dash.](/assets/gifs/gettingstarted/dash-marquee.gif)

To use shift-click, hold down the shift key while left-clicking on multiple documents.

![Screen recording: shift click in Dash.](/assets/gifs/gettingstarted/dash-shift-click.gif)

To select text in PDFs and webpages (not text documents), click and drag to highlight the desired text.

![Screen recording: highlight select in Dash.](/assets/gifs/gettingstarted/dash-highlight-select.gif)
...
- **Properties panel**: panel displaying document type-specific actions
  - Accessed via (A) the double arrows in the top right or (B) the single arrow on the right edge of the screen
    ![](/assets/gifs/gettingstarted/dash-properties-pane.gif)
- **Right-click/Context menu**: menu displaying actions on documents
  - Accessed by right-clicking anywhere on the target document or selecting the three bars menu at the bottom of the document chrome
    ![](/assets/gifs/gettingstarted/dash-context-menu.gif)

All documents also have a context-sensitive toolbar. The toolbar contents vary depending on the document type.

![Screenshot: context toolbar in Dash.](/assets/images/getting-started/context-toolbar.png)
...
- **Close**
  ...
  - All recently closed documents can be accessed through the "My Recently Closed" section in the files portion of the left side-bar. From here, closed documents can be viewed or dragged back onto the canvas.
    ...
    ![](/assets/gifs/gettingstarted/recently-closed.gif)
...
![Screen recording: Opening a document in the full-screen lightbox view.](/assets/gifs/gettingstarted/dash-lightbox.gif)
...
### **[Freeform](/guides/views/freeform/)**
...
### **[Stacking](/guides/views/stacking/)**
...
### **[Notetaking](/guides/views/notetaking/)**
...
## **[Links and Anchors](/guides/features/linking/)**
...
For examples on linking between **parts** of documents, check out the [Annotation and Markup](/getting-started/using-dash/#annotation-and-markup) section below.
...
![Screen recording: creating link in Dash.](/assets/gifs/gettingstarted/dash-creating-link.gif)
...
![Screen recording: create link board in Dash.](/assets/gifs/gettingstarted/dash-create-link-board.gif)
...
The default following behavior is to pan the freeform so that the destination document is in view (if it isn't already) and highlight it in orange. You can customize the link following behavior and more in the [link editing](/getting-started/using-dash/#editing-links) section of the properties menu.

![Screen recording: following link in Dash.](/assets/gifs/gettingstarted/dash-following-link.gif)

If you toggle the hand pointing right icon on, clicking on the document will now follow the first linked document.

![Screen recording: follow link onclick in Dash.](/assets/gifs/gettingstarted/dash-follow-link-onclick.gif)
...
![Screen recording: edit link in Dash.](/assets/gifs/gettingstarted/dash-edit-link.gif)
...
![Screen recording: editing link in Dash.](/assets/gifs/gettingstarted/dash-editing-link.gif)
...
![Screen recording: link center zoom in Dash.](/assets/gifs/gettingstarted/dash-link-center-zoom.gif)
...
- Show/hide link: toggles the dotted line created by the show/hide anchor tool above.
  ![](/assets/gifs/gettingstarted/dash-toggle-show-link.gif)
...
In Dash, you can also create links between **parts of documents**. Read the [Annotation and Markup](/getting-started/using-dash/#annotation-and-markup) section below for examples of how to do this!
...
- `Top-right Icon` Click on the annotation icon at the top right of a document to open the annotation sidebar.
  ...
  ![](/assets/gifs/gettingstarted/dash-annotation-icon.gif)
...
- `Highlight` For text, pdfs, and webpages, you can highlight a piece of text and select the annotation icon that appears. This also creates a `link` between the annotation and selected text. Following the link from annotation to selected text will scroll the selection into view. Clicking on the selected text will follow the link and scroll the annotation into view.
  ...
  ![](/assets/gifs/gettingstarted/dash-highlight-anno.gif)

- `Search` After highlighting, you can also click the search icon to search for a document to link to.

  ![](/assets/gifs/gettingstarted/dash-search-anno.gif)
...
- `Marquee` Clicking (left-click) and dragging within an image, webpage, PDF, or video will create a rectangular marquee selection, allowing you to highlight the selected region and create an annotation associated with it. For webpages and pdfs, you can simply click the annotation icon to add an annotation. For other media types, you'll need to drag the annotation icon to another part of the document or freeform to create the annotation. This also creates a `link` between the annotation and marquee selection.
  ...
  ![](/assets/gifs/gettingstarted/dash-pdf-anno-marquee.gif)

  ![](/assets/gifs/gettingstarted/dash-image-marquee-anno.gif)
...
- `Selection to Another Document` To create a link from a selection on a document to another document, first perform the selection (usually left-click and dragging). Then, navigate to the bottom toolbar of the overall document, and drag the link icon to the document you want to link to (create a normal link). Because the selection persists on the source document, the **selection** will be linked rather than the whole document.
  ...
  ![](/assets/gifs/gettingstarted/dash-link-annotation-document.gif)
...
- `Temporal media` On audio and video documents, you can drag a section of the timeline to create an annotation on that time range. You can link other documents to the annotation, and following that link will play that region of the audio or video.
  ...
  ![](/assets/gifs/gettingstarted/dash-audio-anno.gif)

- `Embed` Type directly on a media document (This can be done on images, pdfs, webpages, and videos).

  ![](/assets/gifs/gettingstarted/dash-image-text-embed.gif)

- `Ink` Draw ink strokes directly on a document.

  ![](/assets/gifs/gettingstarted/dash-annotation-ink.gif)
...
![Screen recording: Selecting text and attaching an annotation to the selection.](/assets/gifs/gettingstarted/textannos.gif)
...
![Screen recording: Drawing a marquee selection over a region and turning it into an annotation.](/assets/gifs/gettingstarted/marqueeannos.gif)
...
## **[Presentation Trails](/guides/features/trails/)**
...
![Screen recording: create trail side in Dash.](/assets/gifs/gettingstarted/dash-create-trail-side.gif)

- Pinning a document or a view.

![Screen recording: pin doc in Dash.](/assets/gifs/gettingstarted/dash-pin-doc.gif)
...
![Screen recording: trail transition in Dash.](/assets/gifs/gettingstarted/dash-trail-transition.gif)
...
- **Top menu bar:** this pins the canvas with the pan and zoom of the tab as you are currently viewing it
  ![](/assets/gifs/gettingstarted/dash-pin-with-view.gif)
- **Marquee menu:** this option appears when you right click and drag on the canvas to create a marquee selection and pins the canvas with the marquee bounds as the viewport
  ![](/assets/gifs/trails/pinmarqueeview.gif)
...
![Screen recording: presentation layout content grouping in Dash.](/assets/gifs/gettingstarted/dash-pres-layout-content-grouping.gif)

Check out the details on how to pin with layout and content [here](/guides/features/trails/#other-pinning-options), and how to group slides [here](/guides/features/trails/#slides).

#### Reorganizing slides

To reorganize the slides in your trail, simply drag and drop the slides to the order you want.

![Screen recording: A single slide in a presentation trail, with its controls.](/assets/gifs/gettingstarted/dash-reorganize-slides.gif)
...
![Screen recording: A single slide in a presentation trail, with its controls.](/assets/gifs/gettingstarted/dash-slide-editing.gif)
...
![Screen recording: present trail in Dash.](/assets/gifs/gettingstarted/dash-present-trail.gif)

Alternatively, you can select the mini-player option from the dropdown to present with a mini-player instead.

![Screen recording: Playing a trail in the minimised player.](/assets/gifs/gettingstarted/dash-pres-miniplayer.gif)

## Sharing and permissions

Dash documents can be shared with individuals, with groups, or both, using
four levels of access. The permission model and the group-creation flow are
documented on [collaboration](/guides/features/collaboration/).

![Screen recording: Sharing a dashboard with another user.](/assets/gifs/gettingstarted/sharing.gif)
...
Unsure of how to navigate the overall Dash interface? Check out the **[Overall Environment page](/getting-started/environment/)**.
