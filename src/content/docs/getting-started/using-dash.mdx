...
For an overview of the Dash interface, check out the **[Overall Environment page](/environment/)**, which will introduce you to how to navigate and organize your Dashboards.
...
- **[Text](/documents/text/)**: rich (RTF) text documents that support various text and hypertext features
- **[Webpages](/documents/webpage/)**: HTML webpages from external sites
- **[PDFs](/documents/pdf/)**: PDF files created outside of Dash
- **[Temporal Media](/documents/tempMedia/)**: audio and video files
- **[Ink](/features/ink/)**: ink strokes drawn with the pen or polygon tool
- **[Images](/documents/images/)**: digital images from external sources
...
![](/assets/gifs/gettingstarted/dash-nested-collection.gif)
...
![](/assets/gifs/gettingstarted/dash-create-collection-marquee.gif)
...
## **[Links and Anchors](/features/linking/)**
...
For examples on linking between **parts** of documents, check out the [Annotation and Markup](/getting-started/#annotation-and-markup) section below.
...
![](/assets/gifs/gettingstarted/dash-creating-link.gif)
...
![](/assets/gifs/gettingstarted/dash-create-link-board.gif)
...
The default following behavior is to pan the freeform so that the destination document is in view (if it isn't already) and highlight it in orange. You can customize the link following behavior and more in the [link editing](/getting-started/#editing-links) section of the properties menu.

![](/assets/gifs/gettingstarted/dash-following-link.gif)

If you toggle the hand pointing right icon on, clicking on the document will now follow the first linked document.

![](/assets/gifs/gettingstarted/dash-follow-link-onclick.gif)
...
![](/assets/gifs/gettingstarted/dash-edit-link.gif)
...
![](/assets/gifs/gettingstarted/dash-editing-link.gif)
...
![](/assets/gifs/gettingstarted/dash-link-center-zoom.gif)
...
In Dash, you can also create links between **parts of documents**. Read the [Annotation and Markup](/getting-started/#annotation-and-markup) section below for examples of how to do this!

## **[Annotation and Markup](/features/markup/)**
...
![](/assets/gifs/gettingstarted/textannos.gif)
...
![](/assets/gifs/gettingstarted/marqueeannos.gif)
...
## **[Presentation Trails](/features/trails/)**
...
![](/assets/gifs/gettingstarted/dash-create-trail-side.gif)

- Pinning a document or a view.

![](/assets/gifs/gettingstarted/dash-pin-doc.gif)
...
![](/assets/gifs/gettingstarted/dash-trail-transition.gif)
...
![](/assets/gifs/gettingstarted/dash-pres-layout-content-grouping.gif)

Check out the details on how to pin with layout and content [here](/features/trails/#other-pinning-options), and how to group slides [here](/features/trails/#slides).

#### Reorganizing slides

To reorganize the slides in your trail, simply drag and drop the slides to the order you want.

![](/assets/gifs/gettingstarted/dash-reorganize-slides.gif)
...
![](/assets/gifs/gettingstarted/dash-slide-editing.gif)
...
![](/assets/gifs/gettingstarted/sharing.gif) */}
...
Unsure of how to navigate the overall Dash interface? Check out the **[Overall Environment page](/environment/)**.
