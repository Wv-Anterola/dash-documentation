...
not stop; the document system, generative tools, agent architecture, and desktop
runtime continued to evolve. What stopped was the practice of naming a version.
