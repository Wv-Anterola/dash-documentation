...
trying to judge what a project on the [Project index](/projects/)
...
Almost every project in the [Project index](/projects/) list
...
study](/cohorts/2026/#post-hoc-oversight-of-prompt-injected-agents)
...
- [Project index](/projects/) filtered by system area,
  which maps directly onto the extension points above.
- [Contributing to Dash](/joining-dash/) if you are about
