...
For the full record, see [Cohorts](/cohorts/) and
[Project index](/projects/).

## Architecture

The [Architecture](/system/) page describes the
...
[Getting started](/getting-started/), or
[Overall environment](/environment/) for a tour of the
interface.
