...
/**
 * Reviewed foreground/background pairs. `min` is the WCAG 2.1 AA threshold for
 * that role: 4.5 for body text, 3.0 for large text and for the boundary of a
 * user interface component.
 */
const pairs = [
  { name: 'body text on the page', fg: '--dash-ink', bg: '--dash-surface', min: 4.5 },
  { name: 'body text on a raised surface', fg: '--dash-ink', bg: '--dash-surface-raised', min: 4.5 },
  { name: 'body text on a panel', fg: '--dash-ink', bg: '--dash-panel', min: 4.5 },
  { name: 'secondary text on the page', fg: '--dash-ink-soft', bg: '--dash-surface', min: 4.5 },
  { name: 'secondary text on a raised surface', fg: '--dash-ink-soft', bg: '--dash-surface-raised', min: 4.5 },
  { name: 'link colour on the page', fg: '--dash-blue', bg: '--dash-surface', min: 4.5 },
  { name: 'accent text on the page', fg: '--dash-accent', bg: '--dash-surface', min: 4.5 },
  { name: 'body text on an accent tint', fg: '--dash-ink', bg: '--dash-accent-soft', min: 4.5 },
  { name: 'form control border on the page', fg: '--dash-control-border', bg: '--dash-surface', min: 3 },
  { name: 'form control border on a raised surface', fg: '--dash-control-border', bg: '--dash-surface-raised', min: 3 },
  { name: 'accent boundary against the page', fg: '--dash-accent', bg: '--dash-surface', min: 3 },
  ...
  { name: 'decorative grouping rule', fg: '--dash-rule-strong', bg: '--dash-surface', min: 1.6 },
];
